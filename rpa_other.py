...
# === CONFIGURATION ===
TESSERACT_PATH = r"C:\\Users\\Aarthika.B\\AppData\\Local\\Programs\\Tesseract-OCR\\tesseract.exe"
EXCEL_PATH = r"D:\\InwardFiles\\InwardFiles_TSC.xlsx"
TEMP_IMAGE_PATH = r"D:\\python\\temp_area.png"
# OCR_REGION = (1666, 444, 235, 64)  # x, y, width, height - Adjust for your screen
OCR_REGION = (1114, 285, 159, 45)  # x, y, width, height - Adjust for your screen
WAIT_SHORT = 1
WAIT_LONG = 3
...
def process_excel_and_transfer(excel_file):
    ...
    for index, row in df.iterrows():
        try:
            ...
            # invoice_region = (772,550,94,18)
            invoice_region = (528,342,74,14) 
            # x=722 
            # y=500
                        ...
                        for attempt in range(max_attempts):
                            ...
                            if r.present('ok.png'):
                               ...
                               break
                                ...
                                raise Exception(f"OCR failed after {max_attempts} attempt")
                    time.sleep(WAIT_LONG)
                    break
                elif attempt == max_attempts - 1:
